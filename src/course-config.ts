...
export const courseMeta = slopCourseMetaSchema.parse({
  code: "SLOP3358",
  title: "Edible Matter: Thermodynamics, Transport and Soft-Matter Physics in the Chinese Kitchen",
  session: "Semester 1",
  year: 2027,
  level: 3,
  ...
  endDate: "2027-05-28",
  description:
    "A third-year elective treating Chinese cooking as applied soft-matter physics. " +
    "Across four stages, students measure, model and redesign real food systems " +
    "(dough, gels, emulsions, crisp skins) using the same rheology, transport and " +
    "thermodynamics used to characterise any soft material.",
  tags: ["soft matter", "food physics", "transport phenomena"],
